...
function SignUp() {
    ...
    const signup = async(e)=>{
        ...
        if(!user.email || !user.password || !user.name){
            setError("You have not entered valid Email Id, Password and Name. Please enter mentioned fields properly")
            setShow(true)
        }else{
            try{
                ...
                try {
                    ...
                    setError("You have registered Succesfully")
                    setUser('')
                    setShow(true)
                  } catch (e) {
                    setAdminLoading(false)
                ...
                setAdminLoading(false)
                setError("You Are Already Registerd. Please Try Logging In!.")
                setShow(true)
            }
        }
    }
