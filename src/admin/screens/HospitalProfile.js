                    ...
                    <Col xl={8} className="mt-2">
                        {
                            ...
                            ?
                            <p className="text-danger"><span><i className="fas fa-map-marker-alt"></i></span> Location Details Not Mentioned !</p>
                            :
                    ...
                    <Col  xl={8} className="mt-2">
                        {
                            ...
                            :
                            <p className="text-danger"><span><i className="fas fa-user-plus"></i></span> Grievances Personal Details Not Mentioned !</p>
                        }
                    </Col>
                    <Col  xl={8} className="mt-2">
                        {
                            ...
                            :
                            <p className="text-danger"><span><i className="fas fa-phone-alt"></i></span> Contact Number Not Mentioned !</p>
                        }
                    </Col>
                    <Col  xl={8} className="mt-2">
                        {
                            ...
                            :
                            <p className="text-danger"><span><i className="far fa-envelope"></i></span> Email Id Not Mentioned !</p>
                        }
                    </Col>
                    <Col  xl={8} className="mt-2">
                        {
                            ...
                            :
                            <p className="text-danger"><span><i className="fas fa-fax"></i></span> Fax Number Not Mentioned !</p>
                        }
                    </Col>
                    <Col  xl={8} className="mt-2">
                        {
                    ...
                    <Col xl={8} className="mt-2">
                        {
                            ...
                            :
                            <p className="text-danger text-center" style={{fontWeight:'600'}}>Specialities Details Not Mentioned !</p>
                        }
                    </Col>
                </Row>
                <Row className="hospital_synptoms mt-2">
                    ...
                    <Col xl={8} className="mt-2">
                        {
                            ...
                            :
                            <p className="text-danger text-center" style={{fontWeight:'600'}}>Facilities Details Not Mentioned !</p>
                        }
                    </Col>
                </Row>
                <Row className="hospital_synptoms mt-2">
                    ...
                    <Col xl={8} className="mt-2">
                        {
                            ...
                            :
                            <p className="text-danger text-center" style={{fontWeight:'600'}}>Services Details Not Mentioned !</p>
                        }
                    </Col>
                </Row>
            </Container>
